...
export function Cases() {
  ...
  return (
    <section id="cases" aria-label="Кейсы клиентов" className="relative py-24 bg-[#0F1420]">
        ...
        >
          <div>
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-[#F0F4FF] leading-tight">
              Реальные результаты <span className="gradient-text">реальных компаний</span>
            </h2>
          </div>
          <Button
            variant="outline"
            ...
            return (
              ...
              >
                <div className="relative flex-1">
                  ...
                  <p className="text-[#8B9ABB] text-sm leading-relaxed mb-4">
                    {c.description}
                  </p>

                  {c.quote && (
                    <blockquote className="text-[#8B9ABB] text-sm italic leading-relaxed mb-6 pl-3 border-l-2 border-[rgba(108,99,255,0.3)]">
                      {c.quote}
                    </blockquote>
                  )}
