...
import { Clock, TrendingDown, Users, BarChart2, type LucideProps } from 'lucide-react'
...
export function Problems() {
  ...
  return (
    <section id="problems" className="relative py-24 bg-[#080B14]">
          ...
          {PROBLEMS.map((problem, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-6 rounded-2xl bg-[#0F1420] border border-[rgba(108,99,255,0.12)] hover:border-[rgba(108,99,255,0.35)] transition-all duration-300"
              >
                ...
                <div className="relative">
                  <div className="w-12 h-12 rounded-xl bg-[rgba(239,68,68,0.1)] border border-[rgba(239,68,68,0.2)] flex items-center justify-center mb-4">
                    {IconComponent && <IconComponent size={22} className="text-red-400" strokeWidth={1.5} />}
                  </div>
